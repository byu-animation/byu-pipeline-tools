...
from byuam import Department, Project, Environment, Body
...
return set_list
    ...
    if(value == None):
        ...
        default_set = (value)
    print ("default motherducking set: " + default_set)
    ...
    print ("Default motherducking value       ")
...
def assemble_set(project, environment, assembly, asset, checkout_file):
    ...
    print ('deepTHroot ' + asset.get_name())
...
def hda_parameter_setup(hda, geo, project):
    ...
    print(geo)
    print("CREATE SET MENU BEING CALLED")
