...
def build(
    ...
    for num in range(1, number_of_upper_arm_joints+number_of_lower_arm_joints+1):
        ...
        if num <= number_of_upper_arm_joints:
            mc.joint(name=name + side + '_arm_bendy_'+str(num)+'_JNT_01', position = mc.xform(name + side + '_upper_arm_stretchy_target_'+str(num)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
        else:
            mc.joint(name=name + side + '_arm_bendy_'+str(num)+'_JNT_01', position = mc.xform(name + side + '_lower_arm_stretchy_target_'+str(num-number_of_upper_arm_joints)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
    #reorient chain
    ...
    for num in range(1, number_of_upper_arm_joints+number_of_lower_arm_joints+1):
        # create upper_arm bendy JNTs
        if num <= number_of_upper_arm_joints:
            mc.joint(name=name + side + '_arm_bendy_pointer_'+str(num)+'_JNT_01', position = mc.xform(name + side + '_upper_arm_stretchy_target_'+str(num)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
        else:
            mc.joint(name=name + side + '_arm_bendy_pointer_'+str(num)+'_JNT_01', position = mc.xform(name + side + '_lower_arm_stretchy_target_'+str(num-number_of_upper_arm_joints)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
    #reorient chain
    ...
    for num in range(1, number_of_upper_arm_joints+number_of_lower_arm_joints+1):
        ...
        if num <= number_of_upper_arm_joints:
            mc.joint(name=name + side + '_arm_bendy_'+str(num)+'_BN_01', position = mc.xform(name + side + '_upper_arm_stretchy_target_'+str(num)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
        else:
            mc.joint(name=name + side + '_arm_bendy_'+str(num)+'_BN_01', position = mc.xform(name + side + '_lower_arm_stretchy_target_'+str(num-number_of_upper_arm_joints)+'_cc_01', query=True, translation=True, worldSpace=True), absolute=True, radius=0.005)
    #reorient chain
    ...
    mc.setAttr(name + side + '_arm_splineIK_pointer_curve_simplify_compensate_MD_01.input1X', mc.getAttr(name + side + '_arm_splineIK_pointer_curve_length_info_01.arcLength'))
    mc.setAttr(name + side + '_arm_splineIK_pointer_curve_simplify_compensate_MD_01.input2X', mc.getAttr(name + side + '_arm_splineIK_curve_length_info_01.arcLength'))
