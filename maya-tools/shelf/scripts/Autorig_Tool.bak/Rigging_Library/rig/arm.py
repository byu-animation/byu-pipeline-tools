...
def build(
    ...
    mc.addAttr( arm_settings_control.C, shortName='secondaries_visibility_parameter', longName='Secondaries_Visibility', attributeType='enum', enumName='Off:On:', keyable=True)    
    ...
    mc.move(0.0,-.050,0.0, name + side + '_arm_settings_curve_offset_os_grp_01', relative=True, objectSpace=True)
    ...
    if side=="_LFT":
        ...
        mc.joint(name=name + side + "_upper_arm_FK_JNT_01", position = mc.xform(shoulder_joint, query=True, translation=True, worldSpace=True), absolute=True, radius=0.01)
        mc.parent(name + side + "_upper_arm_FK_JNT_01", name + '_secondary_global_cc_01')
        
        # create lower_arm FK JNT
        mc.joint(name=name + side + "_lower_arm_FK_JNT_01", position = mc.xform(elbow_joint, query=True, translation=True, worldSpace=True), absolute=True, radius=0.01)
        mc.joint( name + side + '_upper_arm_FK_JNT_01', edit=True, zeroScaleOrient=True, orientJoint='xzy', secondaryAxisOrient = 'yup' )
    
        # create wrist FK JNT
        mc.joint(name=name + side + "_wrist_FK_JNT_01", position = mc.xform(wrist_joint, query=True, translation=True, worldSpace=True), absolute=True, radius=0.01)
    ...
    mc.move(0.0,0.0,-.050, hand_cupping_control.Off, relative=True)
    mc.move(0.0,0.0,.050, hand_cupping_control.C + '.rotatePivot', relative=True)
    mc.move(0.0,0.0,.050, hand_cupping_control.C + '.scalePivot', relative=True)
    ...
    if(mc.objExists(name + side + '_thumb_PRO_target_cc_01')):
        ...
        mc.joint(name=name + side + "_thumb_PRO_BN_01", radius=.005)
        ...
        mc.addAttr( thumb_primary_control.C, shortName='secondaries_visibility_parameter', longName='Secondaries_Visibility', attributeType='enum', enumName='Off:On:', keyable=True) 
        ...
        if side == "_LFT":
            ...
            mc.move(.015,.010,0.0, relative=True)
        else:
            mc.select( name + side + '_thumb_primary_cc_01Shape.cv[0:4]' )
            mc.rotate(90.0,0.0,0.0, relative=True)
            mc.scale(5.0,1.0,0.7, relative=True)
        ...
        if(mc.objExists(name + side + '_thumb_MED_target_cc_01')):
            mc.joint(name=name + side + '_thumb_MED_BN_01', radius=.005) 
            ...
            mc.connectAttr(thumb_primary_control.C + '.secondaries_visibility_parameter', thumb_MED_secondary_control.C + '.visibility', force=True)                
        ...
        if(mc.objExists(name + side + '_thumb_DIS_target_cc_01')):
            mc.joint(name=name + side + '_thumb_DIS_BN_01', radius=.005) 
            ...
            mc.connectAttr(thumb_primary_control.C + '.secondaries_visibility_parameter', thumb_DIS_secondary_control.C + '.visibility', force=True)                
            # make offset groups for control
        ...
        if(mc.objExists(name + side + '_thumb_DIS_2_target_cc_01')):
            mc.joint(name=name + side + '_thumb_DIS_2_BN_01', radius=.005)
            ...
            mc.connectAttr(thumb_primary_control.C + '.secondaries_visibility_parameter', thumb_DIS_2_secondary_control.C + '.visibility', force=True)                
            # make offset groups for control
        ...
        if(mc.objExists(name + side + '_thumb_DIS_3_target_cc_01')):
            mc.joint(name=name + side + '_thumb_DIS_3_BN_01', radius=.005)
            ...
            #visibility
            mc.connectAttr(thumb_primary_control.C + '.secondaries_visibility_parameter', thumb_DIS_3_secondary_control.C + '.visibility', force=True)                
            # make offset groups for control
        ...
        mc.joint(name=name + side + '_thumb_JNT_END_01', radius=.005)
    ...
    # other fingers
    for finger in ['index', 'middle', 'ring', 'pinky', 'second_pinky']:

        # base of any finger
        if(mc.objExists(name + side + '_' + finger + '_finger_PRO_target_cc_01')):
            # metacarpal joint
            mc.select(name + side + '_wrist_JNT_01', replace=True)
            mc.joint(name=name + side + '_' + finger + '_metacarpal_BN_01', radius=.005)
            ...
            # proximal phalange
            mc.joint(name=name + side + '_' + finger + '_finger_PRO_BN_01', radius=.005)
            ...
            #add secondaries visibility attribute
            mc.addAttr( current_finger_primary_control.C, shortName='secondaries_visibility_parameter', longName='Secondaries_Visibility', attributeType='enum', enumName='Off:On:', keyable=True) 
            ...
            for metacarpal_shape in metacarpal_shapes:
                mc.connectAttr(current_finger_primary_control.C + '.secondaries_visibility_parameter', metacarpal_shape + '.visibility', force=True)                
            ...
            if side == "_LFT":
                ...
                mc.rotate(90.0,0.0,0.0, relative=True)
                mc.scale(5.0,1.0,0.7, relative=True)
                mc.move(.015,0.007,0.0, relative=True)
            ...
            if(mc.objExists(name + side + '_' + finger + '_finger_MED_target_cc_01')):
                mc.joint(name=name + side + '_' + finger + '_finger_MED_BN_01', radius=.005)
                ...
                #visibility
                mc.connectAttr(current_finger_primary_control.C + '.secondaries_visibility_parameter', current_finger_MED_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + finger + '_finger_DIS_target_cc_01')):
                mc.joint(name=name + side + '_' + finger + '_finger_DIS_BN_01', radius=.005)
                ...
                #visibility
                mc.connectAttr(current_finger_primary_control.C + '.secondaries_visibility_parameter', current_finger_DIS_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + finger + '_finger_DIS_2_target_cc_01')):
                mc.joint(name=name + side + '_' + finger + '_finger_DIS_2_BN_01', radius=.005)
                ...
                #visibility
                mc.connectAttr(current_finger_primary_control.C + '.secondaries_visibility_parameter', current_finger_DIS_2_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + finger + '_finger_DIS_3_target_cc_01')):
                mc.joint(name=name + side + '_' + finger + '_finger_DIS_3_BN_01', radius=.005)
                ...
                #visibility
                mc.connectAttr(current_finger_primary_control.C + '.secondaries_visibility_parameter', current_finger_DIS_3_secondary_control.C + '.visibility', force=True)                
            ...
            mc.joint(name=name + side + '_' + finger + '_finger_JNT_END_01', radius=.005)
    ...
    if side=="_LFT":
        # create scapula JNT
        mc.select(clear=True)
        mc.joint(name=name + side + "_scapula_BN_01", position = mc.xform(scapula_joint, query=True, translation=True, worldSpace=True), absolute=True, radius=0.01)

        # create shoulder JNT
        mc.joint(name=name + side + "_shoulder_JNT_01", position = mc.xform(shoulder_joint, query=True, translation=True, worldSpace=True), absolute=True, radius=0.01)
