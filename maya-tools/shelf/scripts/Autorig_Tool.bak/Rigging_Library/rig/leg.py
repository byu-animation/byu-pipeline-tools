...
def build(
    ...
    mc.addAttr( leg_settings_control.C, shortName='secondaries_visibility_parameter', longName='Secondaries_Visibility', attributeType='enum', enumName='Off:On:', keyable=True)    
    ...
    for toe in ['big', 'index', 'middle', 'fourth', 'pinky', 'second_pinky']:
        ...
        if(mc.objExists(name + side + '_' + toe + '_toe_PRO_target_cc_01')):
            ...
            mc.addAttr( current_toe_primary_control.C, shortName='secondaries_visibility_parameter', longName='Secondaries_Visibility', attributeType='enum', enumName='Off:On:', keyable=True) 
            ...
            if(mc.objExists(name + side + '_' + toe + '_toe_MED_target_cc_01')):
                ...
                #visibility
                mc.connectAttr(current_toe_primary_control.C + '.secondaries_visibility_parameter', current_toe_MED_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + toe + '_toe_DIS_target_cc_01')):
                ...
                #visibility
                mc.connectAttr(current_toe_primary_control.C + '.secondaries_visibility_parameter', current_toe_DIS_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + toe + '_toe_DIS_2_target_cc_01')):
                ...
                #visibility
                mc.connectAttr(current_toe_primary_control.C + '.secondaries_visibility_parameter', current_toe_DIS_2_secondary_control.C + '.visibility', force=True)                
            ...
            if(mc.objExists(name + side + '_' + toe + '_toe_DIS_3_target_cc_01')):
                ...
                #visibility
                mc.connectAttr(current_toe_primary_control.C + '.secondaries_visibility_parameter', current_toe_DIS_3_secondary_control.C + '.visibility', force=True)                
    ...
    mc.parent(FK_joints_offset_group, IK_joints_offset_group, base_joints_offset_group, name + side + '_leg_joints_GRP_01')
    ...
    mc.parentConstraint(name + '_hips_cc_01', name + side + '_shoulder_PSR_GRP_01', maintainOffset=True)
