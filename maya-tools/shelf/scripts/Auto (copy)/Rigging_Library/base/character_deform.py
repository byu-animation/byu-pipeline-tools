    ...
    for object in geometry_list:
        ...
        if mel.eval('findRelatedSkinCluster ' + object) == '':
            ...
            if object == character_name + '_tongue_GEO_01':
                mc.skinCluster( character_name + '_jaw_BN_01', character_name + '_tongue_root_BN_01', character_name + '_tongue_middle_BN_01', character_name + '_tongue_tip_BN_01', object, toSelectedBones=True)   
