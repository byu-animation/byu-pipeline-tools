...
class Department:
	...
	ASSET_DEPTS = [DESIGN, MODEL, RIG, TEXTURE, MATERIAL, ASSEMBLY, RIB_ARCHIVE]
	SHOT_DEPTS = [LAYOUT, ANIM, CFX, FX, LIGHTING, RENDER, COMP, RIB_ARCHIVE]
	TOOL_DEPTS = [HDA]
	CROWD_DEPTS = [CYCLES]
	ALL = [DESIGN, MODEL, RIG, TEXTURE, MATERIAL, ASSEMBLY, LAYOUT, ANIM, CFX, FX, LIGHTING, RENDER, COMP, HDA, RIB_ARCHIVE]
